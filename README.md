...
Instale as dependências: pip install opencv-python
...
O ambiente virtual (venv) e arquivos de cache estão listados no .gitignore

Os modelos Haar Cascade são carregados diretamente do OpenCV
